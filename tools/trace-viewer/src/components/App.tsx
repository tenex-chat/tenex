...
import type { TraceSummary, Trace } from '../types.js';
...
export function App({ jaegerUrl = 'http://localhost:16686', serviceName = 'tenex-daemon' }: AppProps) {
    ...
    return (
      <Box flexDirection="column">
        ...
        <Box borderStyle="single" borderColor="cyan" paddingX={1}>
          <Text bold color="cyan">Trace {currentTraceIndex + 1}/{traces.length}</Text>
