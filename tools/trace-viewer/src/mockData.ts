            ...
            },
            {
              ...
              attributes: {
                ...
                'ai.prompt.messages': JSON.stringify([
                  ...
                  { role: 'user', content: 'Refactor the authentication system...' },
                ]),
                  ...
                  events: [
                    {
                      ...
                      attributes: {
                        ...
                        'tool.args_preview': '{"phase":"code_analysis","recipient":"coder1","request":"Analyze current auth implementation"}',
                      },
                    },
                    {
                      ...
                      attributes: {
                        ...
                        'tool.call_id': 'call_001',
                        'tool.error': false,
                        'tool.result_preview': '{"success":true,"delegationEventId":"evt_del_001"}',
                      },
                    },
                  ],
                  children: [],
                  ...
                  events: [
                    {
                      ...
                      attributes: {
                        ...
                        'tool.args_preview': '{"phase":"testing","recipient":"tester","request":"Create test plan for OAuth2"}',
                      },
                    },
                    {
                      name: 'tool.execution_complete',
                      ...
                      attributes: {
                        ...
                        'tool.call_id': 'call_002',
                        'tool.error': false,
                        'tool.result_preview': '{"success":true,"delegationEventId":"evt_del_002"}',
                      },
                    },
                  ],
                  children: [],
                      ...
                      events: [
                        {
                          ...
                          attributes: {
                            'tool.name': 'read_file',
                            'tool.args_preview': '{"path":"src/auth/login.ts"}',
                          },
                        },
                        {
                          name: 'tool.execution_complete',
                          ...
                          attributes: {
                            'tool.name': 'read_file',
                            'tool.error': false,
                            'tool.result_preview': 'export function login(username: string, password: string) { ... }',
                          },
                        },
                      ],
                      children: [],
