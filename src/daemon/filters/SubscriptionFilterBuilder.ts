 ...
 */
export function buildStaticFilters(whitelistedPubkeys: Set<Hexpubkey>): NDKFilter[] {
 ...
 */
export function buildReportFilter(knownProjects: Set<string>): NDKFilter | null {
    if (knownProjects.size === 0) {
        return null;
    }
