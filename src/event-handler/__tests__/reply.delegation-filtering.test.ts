  ...
  it("delegation event from Execution Coordinator to claude-code DOES trigger claude-code execution", async () => {
    ...
    const delegationEvent: NDKEvent = {
      ...
      getMatchingTags: (tag: string) => {
        if (tag === "p") {
          return [["p", "ca884a53843ad13d057207686b52b341874c0fa37a28df202f9cf817d81d7f83"]];
        }
    ...
    console.log("addEvent calls:", (mockConversationCoordinator.addEvent as any).mock.calls.length);
