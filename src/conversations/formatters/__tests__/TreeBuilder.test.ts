...
describe('TreeBuilder', () => {
    ...
    describe('tool call extraction', () => {
        it('should extract from tool tag', () => {
            const events = [
                createMockEvent('1', 'Reading file', 'agent', [['tool', 'read_file', 'config.json']])
            ];
        ...
        it('should extract from content pattern', () => {
            const events = [
                createMockEvent('1', 'Now calling tool: grep("pattern")', 'agent')
            ];
        ...
        it('should handle tool calls without args', () => {
            const events = [
                createMockEvent('1', 'Executing: list_files', 'agent')
            ];
