...
describe('ThreadedConversationFormatter', () => {
    ...
    describe('buildThreadTree', () => {
        it('should build a simple linear thread', () => {
            ...
            const tree = formatter.buildThreadTree(events);
        ...
        it('should build a branching thread', () => {
            const events = [
    ...
    describe('extractAgentBranches', () => {
        it('should extract branches where agent participated', () => {
            const events = [
        ...
        it('should include full context when agent is deep in thread', () => {
            const events = [
    ...
    describe('formatThread', () => {
        it('should format thread with ASCII tree style', () => {
            const events = [
    ...
    describe('formatOtherBranches', () => {
        it('should format branches excluding active ones', () => {
            const events = [
            ...
            const formatted = formatter.formatOtherBranches(events, 'agent1', activeBranchIds);
