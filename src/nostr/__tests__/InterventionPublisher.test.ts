 ...
 * - Event has correct tags (p, original-conversation, context, user-pubkey, agent-pubkey, a)
 * - Event content is properly formatted
...
describe("AgentEventEncoder.encodeInterventionReview()", () => {
    ...
    it("should include original-conversation tag", () => {
        const intent: InterventionReviewIntent = {
            targetPubkey: "target-pubkey-123456789012345678901234567890123456",
            conversationId: "conv-id-123456789012345678901234567890123456789012",
            userPubkey: "user-pubkey-123456789012345678901234567890123456",
        ...
        expect(convTag?.[1]).toBe("conv-id-123456789012345678901234567890123456789012");
    });
    ...
    it("should include user-pubkey tag", () => {
        const intent: InterventionReviewIntent = {
            targetPubkey: "target-pubkey-123456789012345678901234567890123456",
            conversationId: "conv-id-123456789012345678901234567890123456789012",
            userPubkey: "user-pubkey-123456789012345678901234567890123456",
        ...
        expect(userTag?.[1]).toBe("user-pubkey-123456789012345678901234567890123456");
    });

    it("should include agent-pubkey tag", () => {
        const intent: InterventionReviewIntent = {
            targetPubkey: "target-pubkey-123456789012345678901234567890123456",
            conversationId: "conv-id-123456789012345678901234567890123456789012",
            userPubkey: "user-pubkey-123456789012345678901234567890123456",
        ...
        expect(agentTag?.[1]).toBe("agent-pubkey-123456789012345678901234567890123456");
    });
    ...
    it("should format content with shortened IDs", () => {
        const intent: InterventionReviewIntent = {
            targetPubkey: "target-pubkey-123456789012345678901234567890123456",
            conversationId: "conv-id-123456789012345678901234567890123456789012",
            userPubkey: "user-pubkey-123456789012345678901234567890123456",
        ...
        // Verify content uses shortened IDs (12 chars for conversationId, 8 chars for pubkeys)
        expect(event.content).toContain("conv-id-1234"); // First 12 chars
        expect(event.content).toContain("user-pub"); // First 8 chars
        expect(event.content).toContain("agent-pu"); // First 8 chars
...
describe("InterventionPublisher", () => {
    ...
    it("should publish event with all required tags", async () => {
        ...
        expect(tags.find((t) => t[0] === "original-conversation")).toBeDefined();
        expect(tags.find((t) => t[0] === "context")).toBeDefined();
        expect(tags.find((t) => t[0] === "user-pubkey")).toBeDefined();
        expect(tags.find((t) => t[0] === "agent-pubkey")).toBeDefined();
