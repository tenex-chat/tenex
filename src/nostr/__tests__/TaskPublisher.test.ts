...
describe("TaskPublisher", () => {
    ...
    describe("completeTask", () => {
        it("should throw error if no current task exists", async () => {
            await expect(
                taskPublisher.completeTask(true, { sessionId: "test-session" })
            ).rejects.toThrow("No current task to complete. Call createTask first.");
        });
    ...
    describe("publishTaskProgress", () => {
        it("should throw error if no current task exists", async () => {
            await expect(
                taskPublisher.publishTaskProgress("Progress update")
            ).rejects.toThrow("No current task for progress updates. Call createTask first.");
        });
    ...
    describe("edge cases", () => {
        ...
        it("should handle very long progress content", async () => {
            ...
            await expect(
                taskPublisher.publishTaskProgress(longContent)
            ).resolves.toBeUndefined();
