...
export class DelegationService {
    ...
    static async createDelegationTasks(
        ...
        // Create and publish NDKTask events for each recipient
        ...
        for (const recipientPubkey of resolvedPubkeys) {
            ...
            // CRITICAL FIX: Register task mapping so completions route to parent conversation
            ...
            logger.debug("Published NDKTask with mapping", {
                taskId: task.id,
                conversationId,
                phase: phase || "none",
