...
describe("ConfigService", () => {
    ...
    describe("loadConfig integration", () => {
        it("should properly merge configs from different sources", async () => {
            ...
            const loaded1 = await service.loadTenexConfig(service.getProjectPath(path.join(tempDir, "proj1")));
            const loaded2 = await service.loadTenexConfig(service.getProjectPath(path.join(tempDir, "proj2")));
