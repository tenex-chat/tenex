...
import { z } from 'zod';
import type { ExecutionEnvironment, AISdkTool } from '@/tools/types';
...
const create${toolName.charAt(0).toUpperCase() + toolName.slice(1)}Tool = (context: ExecutionEnvironment): AISdkTool => {
    const aiTool = tool({
