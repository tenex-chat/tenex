...
pub(crate) struct ToolSet {
    ...
    pub agents_md: Arc<AgentsMdReminderState>,
    pub shell_env: Vec<(String, String)>,
    pub granted_tools: HashSet<String>,
    pub todos: Arc<Mutex<Vec<TodoItem>>>,
    pub skill_list: SkillListTool,
    pub skills_set: SkillsSetTool,
    pub mcp_proxy_tools: Vec<McpProxyTool>,
    pub delegate: Option<DelegateTool>,
    pub rag_add_documents: RagAddDocumentsTool,
    pub rag_search: RagSearchTool,
    pub runtime_state: Option<RuntimeStateHandle>,
    pub message_injections: Arc<Mutex<MessageInjectionTracker>>,
    pub telegram_config: Option<tenex_telegram::config::TelegramAgentConfig>,
